<?php
  ...
  $sql = 'SELECT * FROM daftarpernikahan d JOIN akunjemaat j ON d.iduser=j.idAkun WHERE idgereja='.$_SESSION['gereja'];
...
<html lang="en" dir="ltr">
  <head>
    <title>Daftar Jemaat yang Mendaftar Pemberkatan Nikah</title>
...
<br><br><br>
    <div class="container">
        <br>
        <h2><i class="fa fa-chevron-left" onclick="window.location.href='homeAdmin.php'"></i> Pendaftaran Pemberkatan Nikah </h2>
        <br><br>
            ...
            <table id="example" class="table table-striped" style="width:100%; text-align: center;">
                <thead>
                    <tr>
                        ...
                        <th>No. Telp Pengantin Pria</th>
                        <th>Status Baptis Pengantin Pria</th>
                        <th>Nama Pengantin Wanita</th>
                        <th>No. Telp Pengantin Wanita</th>
                        <th>Status Baptis Pengantin Wanita</th>
                        <th>Tanggal Pemberkatan</th>
                        <th>Lokasi Pemberkatan</th>
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['namapria']?></td>
                        <td><?php echo $data['notelppria']?></td>
                        <td><?php if ($data['statuspria']==0) { echo '<i class="fas fa-times" style="color:red"> Belum Dibaptis</i>'; } else { echo '<i class="fas fa-check" style="color:green"> Sudah Dibaptis</i>'; } ?></td>
                        <td><?php echo $data['namawanita']?></td>
                        <td><?php echo $data['notelpwanita']?></td>
                        <td><?php if ($data['statuswanita']==0) { echo '<i class="fas fa-times" style="color:red"> Belum Dibaptis</i>'; } else { echo '<i class="fas fa-check" style="color:green"> Sudah Dibaptis</i>'; } ?></td>
                        <td><?php echo $data['tanggalpemberkatan']?></td>
