<?php
  ...
  $sql = 'SELECT * FROM kesaksianjemaat d JOIN akunjemaat j ON d.iduser=j.idAkun WHERE idgereja='.$_SESSION['gereja'];
...
<html lang="en" dir="ltr">
  <head>
    <title>Daftar Jemaat yang Memberikan Kesaksian</title>
...
<br><br><br>
    <div class="container">
        <br>
        <h2><i class="fa fa-chevron-left" onclick="window.location.href='homeAdmin.php'"></i> Kesaksian Jemaat </h2>
        <br><br>
            ...
            <table id="example" class="table table-striped" style="width:100%; text-align: center;">
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['isikesaksian']?></td>
                        ...
                        <td id="K<?php echo $data['idkesaksian'];?>"><?php if ($data['respon']==1) { echo '<button class="btn btn-primary" onclick="batal('.$data['idkesaksian'].')">Terkonfirmasi</button>'; } else { echo '<button class="btn btn-warning" onclick="konfirmasi('.$data['idkesaksian'].')">Pending...</button>'; }?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
