<?php
  ...
  $sql = 'SELECT * FROM daftarbaptis d JOIN akunjemaat j ON d.iduser=j.idAkun WHERE idgereja='.$_SESSION['gereja'];
...
<html lang="en" dir="ltr">
  <head>
    <title>Daftar Jemaat yang Mendaftar Pembaptisan</title>
...
<br><br><br>
    <div class="container">
        <br>
        <h2><i class="fa fa-chevron-left" onclick="window.location.href='homeAdmin.php'"></i> Pendaftaran Pembaptisan </h2>
        <br><br>
            ...
            <table id="example" class="table table-striped" style="width:100%; text-align: center;">
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td><?php if($data['statusbaptis']==1) {
                            echo "Belum Pernah Dibaptis"; 
                        } elseif ($data['statusbaptis']==2) {
                            echo "Pernah Menerima Baptis Anak";
                        } elseif ($data['statusbaptis']==3) {
                            echo "Sudah Pernah Dibaptis";
                        }  ?></td>
