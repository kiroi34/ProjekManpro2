<?php
  ...
  $sql = 'SELECT * FROM daftarcg d JOIN akunjemaat j ON d.iduser=j.idAkun WHERE idgereja='.$_SESSION['gereja'];
...
<html lang="en" dir="ltr">
  <head>
    <title>Daftar Jemaat yang Mendaftar Komunitas Sel</title>
...
<br><br><br>
    <div class="container">
        <br>
        <h2><i class="fa fa-chevron-left" onclick="window.location.href='homeAdmin.php'"></i> Pendaftaran Komunitas Sel </h2>
        <br><br>
