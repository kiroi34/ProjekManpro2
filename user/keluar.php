...
<div class="bg-image"> </div>
  <form action="login.php" method = "post" class="container">
    ...
    <input type="checkbox" onclick="myFunction() "> <span style = "color : #f4f2ff">Lihat Password </span>
    <div class="link forget-pass text-left"><p style = "font-size: 75%"><a href="lupapass.php"><span style = "color : #f59d06">Lupa password?</span></a></div>
        ...
        <button type="submit" class="btn"><a href ="Homeuser.php">Masuk</button>
  </form>
</body>