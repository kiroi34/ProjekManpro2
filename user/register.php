...
<div class="bg-image"> </div>
  <form action="inputnewuser.php" method = "post" class="container">
    ...
    <input type="text" placeholder="Masukkan No Hp" name="notelp" required>
    <label for="nama"><b style = "color : #f4f2ff">Email</b></label>
    <input type="text" placeholder="Masukkan email " name="email" required>
    <label for="nama"><b style = "color : #f4f2ff">Alamat</b></label>
    ...
    <input type="password" placeholder="Konfirmasi Password" name="confpassword" required>
    <div style="size: 20px;">
    <p style= "font-size: 75%"><span style = "color : #f4f2ff">Sudah punya akun?<a href="keluar.php"> <span style = "color : #f59d06">Login </pan> </a> </p>
        <button type="submit" class="btn"><a href= "keluar.php">Register</button>
    </div>
  </form>
</body>