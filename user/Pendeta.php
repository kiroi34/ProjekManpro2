...
$records = mysqli_query($sambung,"select id, jabatan.namaJabatan, nama, biodata, foto from pendeta inner join jabatan on jabatan.idJabatan=pendeta.jabatan where idgereja = ".$_SESSION['gereja']); // fetch data from database harus pakai join buat jabatan
