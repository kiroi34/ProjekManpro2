...
<input type="tel" id="nameField" class="form-control" name="CongregationalServiceForm[name]" maxlength="50" placeholder="Nama Gereja">
...
<input type="tel" id="emailField" class="form-control" name="CongregationalServiceForm[email]" maxlength="50" placeholder="Email">
...
<input type="tel" id="jamField" class="form-control" name="CongregationalServiceForm[jam]" maxlength="50" placeholder="Jam Operasional Gereja">
...
<input type="tel" id="kotaField" class="form-control" name="CongregationalServiceForm[kota]" maxlength="50" placeholder="Kota">
