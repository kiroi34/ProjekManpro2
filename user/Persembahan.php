          ...
          <ul id="navGive" class="nav nav-pills nav-fill text-center" role="tablist">
            <li class="nav-item">
              <a class="nav-link active " style="background-color: blue;" id="bank-transfer-tab" data-toggle="tab" role="tab" href="#bank-transfer">
                Bank Transfer &amp; QRIS      </a>
            </li>
            <li class="nav-item">
              <a class="nav-link bg-lightgrey" id="credit-card-tab" data-toggle="tab" role="tab" href="#credit-card">
                Credit Card      </a>
            </li>
          </ul>
          <div class="container">
                    ...
                    <div id="giveContent_8f4c6a26b91c743ac3168a8f7c022e2b" class="tabcontent tabcontent_8f4c6a26b91c743ac3168a8f7c022e2b">
                        <div class="row align-items-center mt-2 bank-account-wrapper">
                            <div class="col-8" style="padding-right:5px; margin-top : 50px">
                                <div style="font-size:1.2em;line-height:1em; width:max-content; margin-left: 50px;"><b>Gereja Kristen Indonesia</b></div> <br>
                                <div style="font-size:13px; margin-left:50px; font-size:15px;"> <b>GEREJA Kristen Lorum</b> </div> <br>
                                <div class="copy-to-clipboard" data-placement="bottom" title="Copied" data-clipboard-text="0882977771">
                                    <b style="font-size:1.3em;line-height:1.3em; margin-left: 50px; background-color: lightgray;"><a href="javascript:void(0)">BCA 081.2.3456.0</a></b>
                                  ...
                                  <div class="mt-2" style="font-size:0.8em; margin-top:50px; margin-left: 50px;">
                                    Scan QR Code dengan aplikasi berikut ini:</div>
                                <div class="mt-2" style="margin-top:50px; margin-left: 50px;">
                                  <img loading="lazy" src="https://gmschurch.azureedge.net/gmsbaratlandingpagedata/images/mobile-payment-apps-icon.png" alt="QR" height="30"> <br>
                            ...
                            <div class="col-4" style="padding-left:5px;">
                                ...
                                <input type="tel" id="ageField" class="form-control" name="CongregationalServiceForm[age]" style="max-width:220px;width:170%; margin-left: 60px;" 
